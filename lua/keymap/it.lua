...
local plug_map = {
  ...
  ['n|<Leader>fa'] = map_cu('Telescope live_grep find_command=rg,--ignore,--hidden,--files prompt_prefix=🔍')
    :with_noremap()
    :with_silent(),
  ...
  ['n|<Leader>fd'] = map_cu('Telescope dotfiles path=' .. os.getenv('HOME') .. '/.dotfiles')
    :with_noremap()
    :with_silent(),
